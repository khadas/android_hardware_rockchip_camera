...
#ifndef _HI551_PRIV_H
#define _HI551_PRIV_H
...
#define Sensor_CHIP_ID_HIGH_BYTE            (0x0f16)  
#define Sensor_CHIP_ID_LOW_BYTE          (0x0f17) 

#define Sensor_CHIP_ID_HIGH_BYTE_DEFAULT            (0x05) // 
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT          (0x51)  

#define Sensor_MODE_SELECT  (0x0118)
