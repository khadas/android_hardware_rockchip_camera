 ...
 *****************************************************************************/
CREATE_TRACER( Sensor_INFO , "IMX179: ", INFO,    0U );
CREATE_TRACER( Sensor_WARN , "IMX179: ", WARNING, 1U );
CREATE_TRACER( Sensor_ERROR, "IMX179: ", ERROR,   1U );

CREATE_TRACER( Sensor_DEBUG, "IMX179: ", INFO,     0U );

CREATE_TRACER( Sensor_REG_INFO , "IMX179: ", INFO, 0);
CREATE_TRACER( Sensor_REG_DEBUG, "IMX179: ", INFO, 0U );
	...
	if(pSensorCtx->IsiSensorMipiInfo.ucMipiLanes == SUPPORT_MIPI_ONE_LANE){
	    ...
	    {                  
            ...
            case ISI_RES_1640_1232P30: 
            {
    		    ...
    		    osSleep( 10 );
				pSensorCtx->IsiSensorMipiInfo.ulMipiFreq = 648;
                break;
            }
...
)
{
    ...
    if ( pDummyCtx == NULL )
    {
        TRACE( Sensor_ERROR,  "%s: Can't allocate dummy IMX179 context\n",  __FUNCTION__ );
        return ( RET_OUTOFMEM );
    }
