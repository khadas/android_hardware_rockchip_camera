...
#ifndef __IMX274_PRIV_H__
#define __IMX274_PRIV_H__
...
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT          (0x11) // r - 
#else
...
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT          (0x00) // r - 
#endif
#define Sensor_MODE_SELECT  (0x3000)

#define Sensor_SOFTWARE_RST                 (0x3001) // rw - Bit[7:1]not used  Bit[0]software_reset
