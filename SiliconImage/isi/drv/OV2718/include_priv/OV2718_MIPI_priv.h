#ifndef __OV2718_PRIV_H__
#define __OV2718_PRIV_H__
...
#define Sensor_CHIP_ID_HIGH_BYTE_DEFAULT    (0x27) // r - 
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT     (0x70) // r - 

#define Sensor_MODE_SELECT                  (0x3012)

#define Sensor_SOFTWARE_RST                 (0x3013) // rw - Bit[7:1]not used  Bit[0]software_reset
