...
LOCAL_SRC_FILES:=\
	source/OV7251_MIPI.c\
	source/OV7251_tables.c\
...
LOCAL_CFLAGS := -Wall -Wextra -std=c99   -Wformat-nonliteral -g -O0 -DDEBUG -pedantic -Wno-zero-length-array -Wno-unused-parameter -Wno-unused-variable -Wno-c11-extensions \
-Wno-unused-function -Wno-missing-field-initializers -Wno-sometimes-uninitialized -Wno-parentheses-equality -Wno-pointer-sign -Wno-incompatible-pointer-types
...
LOCAL_MODULE:= libisp_isi_drv_OV7251
