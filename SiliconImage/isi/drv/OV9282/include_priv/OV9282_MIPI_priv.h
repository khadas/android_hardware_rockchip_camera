 ...
 *  \version     1.0 \n
 *  \author      Meinicke \n
 *  \brief       Private header file for sensor specific code of the OV9282. \n
 *
 *  \revision    $Revision: 432 $ \n
 *               $Author: neugebaa $ \n
 *               $Date: 2009-06-30 11:48:59 +0200 (Di, 30 Jun 2009) $ \n
 *               $Id: OV9282_priv.h 432 2009-06-30 09:48:59Z neugebaa $ \n
 */
...
/*
#ifndef _OV9282_PRIV_H
#define _OV9282_PRIV_H

#include "isi_priv.h"

#if( OV9282_DRIVER_USAGE == USE_CAM_DRV_EN )
*/


#ifndef __OV9282_PRIV_H__
#define __OV9282_PRIV_H__
...
*v0.c.0
*   1)  Skip frames when resolution change in OV9282_IsiChangeSensorResolutionIss;
*v0.d.0
*   1). support OTP;
*v0.e.0
...
*v1.6.0:
*   1). OV9282_IsiGetAfpsInfoIss support one lane.
*v1.7.0
 ...
 *****************************************************************************/
//hkw  
#define OV9282_MODE_SELECT                  (0x0100) // rw - Bit[7:1]not used  Bit[0]Streaming set 0: software_standby  1: streaming       
#define OV9282_MODE_SELECT_OFF              (0x00U)
#define OV9282_MODE_SELECT_ON				(0x01U)

#define OV9282_SOFTWARE_RST                 (0x0103) // rw - Bit[7:1]not used  Bit[0]software_reset
#define OV9282_SOFTWARE_RST_VALUE			(0x01)

#define OV9282_CHIP_ID_HIGH_BYTE            (0x300a) // r - 
//#define OV9282_CHIP_ID_MIDDLE_BYTE          (0x300b) // r - ,no use mtcai
#define OV9282_CHIP_ID_LOW_BYTE             (0x300b) // r -  
#define OV9282_CHIP_ID_HIGH_BYTE_DEFAULT            (0x92) // r - 
//#define OV9282_CHIP_ID_MIDDLE_BYTE_DEFAULT          (0x88) // r - 
#define OV9282_CHIP_ID_LOW_BYTE_DEFAULT             (0x81) //(0x65) // r - 

                                                    //     Bit[3] gain manual enable 0:manual disable use register 0x350a/0x350b   1:manual enable use register 0x3504/0x3505
#define OV9282_AEC_AGC_ADJ_H                (0x3508) // rw- Bit[2:0]gain output to sensor Gain[10:8]
#define OV9282_AEC_AGC_ADJ_L                (0x3509) // rw- Bit[7:0]gain output to sensor Gain[7:0] 

#define OV9282_AEC_EXPO_H                   (0x3500) // rw- Bit[3:0] exposure[19:16]
#define OV9282_AEC_EXPO_M                   (0x3501) // rw- Bit[7:0] exposure[15:8]
#define OV9282_AEC_EXPO_L                   (0x3502) // rw- Bit[7:0] exposure[7:0] low 4 bits are fraction bits which are not supportted and should always be 0.
 ...
 *****************************************************************************/
typedef struct OV9282_VcmInfo_s                 /* ddl@rock-chips.com: v0.3.0 */
{
...
typedef struct OV9282_Context_s
{
